/*
 ** Copyright © 2024 Thomas Sanchez <me@thomas-sanchez.me>
...
/* redefine the ascii_to_keycode so that the register_unicode works. */
...
const ergol_key_t ergol_key_maps[IDX(EKC_MAX)] = {
    ...
    [IDX(EKC_MNS)] = EGL_WITH_SBASE(FR_MINS,  FR_QUES, CP(0x2011) /* ‑ */, CP(0x00BF) /* ¿ */,   FR_RBRC,    CP(0x0328) /* ̨  Combining Ogonek */),
    [IDX(EKC_V)] = EGL(FR_V,       CP(0x2013) /* – */, KC_TRNS,            FR_UNDS,    CP(0x2013) /* – en dash */),
    [IDX(EKC_B)] = EGL(FR_B,       CP(0x2014) /* — */, KC_TRNS,            FR_HASH,     KC_TRNS),
...
const ergol_key_t ergol_key_maps[IDX(EKC_MAX)] = {
    ...
    [IDX(EKC_MNS)] = EGL_WITH_SBASE(KC_MINS,  KC_QUES, CP(0x2011) /* ‑ */, CP(0x00BF) /* ¿ */,   KC_RBRC,    CP(0x0328) /* ̨  Combining Ogonek */),
    [IDX(EKC_V)] = EGL(KC_V,       CP(0x2013) /* – */, KC_TRNS,            KC_UNDS,    CP(0x2013) /* – en dash */),
    [IDX(EKC_B)] = EGL(KC_B,       CP(0x2014) /* — */, KC_TRNS,            KC_HASH,     KC_TRNS),
...
#define FN_OR_ESC LT(FN_LAYER, KC_ESC)

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [ERGOL] = LAYOUT(
        KC_ESC ,  EKC_1 ,  EKC_2 ,  EKC_3 ,  EKC_4 ,  EKC_5 , FN_OR_ESC,       FN_OR_ESC,  EKC_6 ,  EKC_7,   EKC_8 ,  EKC_9 ,  EKC_0 , QK_BOOT,

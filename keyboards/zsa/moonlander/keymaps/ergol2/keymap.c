...
const key_override_t Sym_EKC_Q     = ko_make_with_layers(MOD_MASK_SHIFT, KC_CIRC, UM(EKC_Q_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_C     = ko_make_with_layers(MOD_MASK_SHIFT, KC_LABK, UM(EKC_C_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_O     = ko_make_with_layers(MOD_MASK_SHIFT, KC_RABK, UM(EKC_O_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_P     = ko_make_with_layers(MOD_MASK_SHIFT, KC_DLR, KC_DLR, (1 << Sym));
const key_override_t Sym_EKC_W     = ko_make_with_layers(MOD_MASK_SHIFT, KC_PERC, UM(EKC_W_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_J     = ko_make_with_layers(MOD_MASK_SHIFT, KC_AT, UM(EKC_J_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_M     = ko_make_with_layers(MOD_MASK_SHIFT, KC_AMPR, KC_AMPR, (1 << Sym));
const key_override_t Sym_EKC_D     = ko_make_with_layers(MOD_MASK_SHIFT, KC_ASTR, UM(EKC_D_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_DK    = ko_make_with_layers(MOD_MASK_SHIFT, KC_QUOT, UM(EKC_DK_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_Y     = ko_make_with_layers(MOD_MASK_SHIFT, KC_GRV, UM(EKC_Y_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_A     = ko_make_with_layers(MOD_MASK_SHIFT, KC_LCBR, UM(EKC_A_Sym_shifted), (1 << Sym));
...
const key_override_t Sym_EKC_N     = ko_make_with_layers(MOD_MASK_SHIFT, KC_RCBR, UM(EKC_N_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_F     = ko_make_with_layers(MOD_MASK_SHIFT, KC_EQL, UM(EKC_F_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_L     = ko_make_with_layers(MOD_MASK_SHIFT, KC_BSLS, UM(EKC_L_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_R     = ko_make_with_layers(MOD_MASK_SHIFT, KC_PLUS, UM(EKC_R_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_T     = ko_make_with_layers(MOD_MASK_SHIFT, KC_MINS, UM(EKC_T_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_I     = ko_make_with_layers(MOD_MASK_SHIFT, KC_SLSH, UM(EKC_I_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_U     = ko_make_with_layers(MOD_MASK_SHIFT, KC_DQUO, UM(EKC_U_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_Z     = ko_make_with_layers(MOD_MASK_SHIFT, KC_TILD, UM(EKC_Z_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_X     = ko_make_with_layers(MOD_MASK_SHIFT, KC_LBRC, UM(EKC_X_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_MNS   = ko_make_with_layers(MOD_MASK_SHIFT, KC_RBRC, UM(EKC_MNS_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_V     = ko_make_with_layers(MOD_MASK_SHIFT, KC_UNDS, UM(EKC_V_DK_base), (1 << Sym));
const key_override_t Sym_EKC_B     = ko_make_with_layers(MOD_MASK_SHIFT, KC_HASH, KC_HASH, (1 << Sym));
const key_override_t Sym_EKC_DOT   = ko_make_with_layers(MOD_MASK_SHIFT, KC_PIPE, UM(EKC_DOT_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_H     = ko_make_with_layers(MOD_MASK_SHIFT, KC_EXLM, UM(EKC_H_Sym_shifted), (1 << Sym));
const key_override_t Sym_EKC_G     = ko_make_with_layers(MOD_MASK_SHIFT, KC_SCLN, UM(EKC_G_Sym_shifted), (1 << Sym));
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DK] = LAYOUT(
        // clang-format off
                         ...
                         _______                 ,    UP(EKC_Q_DK_base, EKC_Q_DK_shifted)   ,    UP(EKC_C_DK_base, EKC_C_DK_shifted)   ,    UP(EKC_O_DK_base, EKC_O_DK_shifted)   ,    UP(EKC_P_DK_base, EKC_P_DK_shifted)   ,                  KC_TRNS                 ,                  _______                 ,                            _______                 ,                  KC_TRNS                 ,             UM(EKC_M_DK_base)            ,                  KC_UNDS                 ,   UP(EKC_DK_DK_base, EKC_DK_DK_shifted)  ,    UP(EKC_Y_DK_base, EKC_Y_DK_shifted)   ,                  _______                 ,
